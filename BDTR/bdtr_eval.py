...
def main():  
    ...
    model_path = 'log/cam_bdtr_trial_1_5000.ckpt'
    save_dir = 'data/'
    ...
    with tf.Session() as sess:
        ...
        feature1 = sess.run(predict1, feed_dict={ x1:test_color_imgs[:test_num], keep_var:  1. })          
        feature2 = sess.run(predict2, feed_dict={ x2:test_thermal_imgs[:test_num], keep_var:  1.})
